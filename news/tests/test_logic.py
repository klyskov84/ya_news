...
class TestCommentEditDelete(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.news = News.objects.create(title='Заголовок', text='Текст')
        # Формируем адрес блока с ки, который понадобится для тестов.
        news_url = reverse('news:detail', args=(cls.news.id,))  # Адрес нови.
        cls.url_to_comments = news_url + '#comments'  # Адрес блока с комриями.
